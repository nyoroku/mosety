...
class StaticViewSitemap(Sitemap):
    ...
    def items(self):
        return [
            ...
            'content:questions',
            'content:plan_hub',
            'content:plan_getting_here',
            'content:plan_best_time',
            'content:plan_what_to_bring',
            'content:plan_children',
            'content:guide_hub',
            'content:guide_hippos',
            'content:guide_birds',
            'content:guide_wildlife',
